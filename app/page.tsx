          ...
          <div>
            <div style={{ textAlign: "center" as const, marginBottom: 24 }}>
              ...
              <p style={{ fontFamily: "'Fraunces', Georgia, serif", fontSize: mobile ? 14 : 16, fontStyle: "italic", color: C.textMuted, lineHeight: 1.6, maxWidth: 620, margin: "0 auto" }}>
                The collectible market runs on trust.<br />We built a vault that runs on proof.<br />Look through The Glass Vault from anywhere, verify everything, take nothing until the seal is broken.
              </p>
            </div>
